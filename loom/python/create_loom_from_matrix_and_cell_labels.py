# Creates a loom file from plain texts files, it takes the following positional arguments
#   - Filepath to a tab-separated or csv table  representing a geb-by-cell count matrix,
#      first column must be gene names, first row must be cell ids
#   - Filepath to a tab-separated or csv table, where each row represents a cellular feature
#     (e.g. cell types). Number of elements in feature must match number of cell in count matrix.
#     The first column must be feature names, with following columns containing values associated to feature
#   - Filepath to output loom file
