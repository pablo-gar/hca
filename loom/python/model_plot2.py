...
def main():
    ...
    #h5ad_file = '/Users/pgarcia-nietochanzuckerberg.com/projects/cell_type_transfer/pancreas/data/hca_model_alternative_integrated.h5ad'
    #out_prefix = '/Users/pgarcia-nietochanzuckerberg.com/projects/cell_type_transfer/pancreas/results/integrated/_model_results_3_training'
    ...
    # Process data
    annData = model_preprocessing.preprocessing(annData, do_log1p=False, do_select_variable_genes=True, do_min_cells_filter=True,
                                                do_min_genes_filter=True, percent_cells=0.05, min_genes=10, n_var_genes=2000, flavor="cell_ranger")
